                    ...
                    Button(action: { viewModel.showingIconPicker.toggle() }) {
                        HStack {
                            ...
                            Image(systemName: viewModel.selectedIcon)
                                .foregroundStyle(Color(hex: viewModel.selectedColor) ?? .blue)
                                .font(.title2)
                ...
                Section("Appearance") {
                    Button(action: { viewModel.showingColorPicker.toggle() }) {
                        HStack {
                            ...
                            Spacer()
                            Circle()
                                .fill(Color(hex: viewModel.selectedColor) ?? .blue)
                            ...
                            VStack {
                                Image(systemName: icon)
                                    ...
                                    .foregroundStyle(
                                        ...
                                        Color(hex: viewModel.selectedColor) ?? .blue : .primary
                                    )
                                    .padding()
                                    .background(
                                        icon == viewModel.selectedIcon ?
                                        Color(hex: viewModel.selectedColor)?.opacity(0.2) ?? .blue.opacity(0.2) :
                                    ...
                                    .overlay(
                                        RoundedRectangle(cornerRadius: Theme.CornerRadius.medium)
                                            .stroke(
                                                icon == viewModel.selectedIcon ?
                                                Color(hex: viewModel.selectedColor) ?? .blue : .clear,
                                                lineWidth: 2
                                            )
                                    )
                            }
                        ...
                        Button(action: {
                            ...
                            Circle()
                                ...
                                .overlay(
                                    Circle()
                                        .stroke(
                                            color == viewModel.selectedColor ? .white : .clear,
                                            lineWidth: 3
                                        )
                                )
                                .overlay(
                                ...
                                .shadow(radius: color == viewModel.selectedColor ? 3 : 0)
                        }
                    }
                }
                .padding()
